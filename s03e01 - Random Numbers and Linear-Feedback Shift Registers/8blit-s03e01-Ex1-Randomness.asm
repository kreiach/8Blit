; S03e01 Ex. 1 Randomness - Bouncing Ball
;
; This example demonstrates several galois linear-feedback shift register routine
; in order to generate pseudo random numbers, and navigatable non-repeating lists.
;
