        processor 6502          ; S03e01 Ex. 1 Randomness - Bouncing Ball
                                ;
        include	 "vcs.h"	; This example demonstrates several galois linear-feedback shift register routine
        include  "macro.h"	; in order to generate pseudo random numbers, and navigatable non-repeating lists.
                                ;
                                ...
                                ;
                                ; Methods of interest
                                ; galois_lfsr_random - Generates a pseudo random number
                                ; galois_lfsr_forward - Moves forward in an lfsr list
                                ; galois_lfsr_backward - Move backwards in a lfsr list
...
;--------------------------------------	 
        ...
        ldx #0                  ; 2  15 - used to disable ball graphic
        ...
        ldx #2                  ; 2  24 - ball y pos and playfield counter are same so enable ball graphic

noball:       
        stx ENABL               ; 3  37 - enable/disable ball graphic
