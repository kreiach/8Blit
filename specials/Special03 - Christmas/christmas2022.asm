    ...
    processor 6502              ; 8blit Christmas Yule Log 2022
    include "vcs.h"             ; A quick and DIRTY routine to draw a 'fire' using the playfield registers.
    include "macro.h"           
                                ...
                                ; Watch the video:
                                ; https://www.youtube.com/watch?v=z5OB81NpcGA&t=41s
