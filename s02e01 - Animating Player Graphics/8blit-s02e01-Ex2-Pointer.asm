                processor 6502		; s02e01 Ex2. Pointer
                include	 "vcs.h"	;
                include  "macro.h"	; Instead of using the address of the graphic, we've
                                    ; created a pointer that points use to the graphics
                                    ; address. This allows us to abstract the address.
                                    ;
...
vblank: 		sta	WSYNC			; (3) 
                ...
                lda #<ghost_f0      ; (2) load LSB from address
