        processor 6502          ; S03E04 Regions
                                ;
        include	"vcs.h"	        ; Demonstrates how to handle the number of scanlines, colors, and timing
        include "macro.h"       ; of different regions of the world with NTSC, PAL, and SECAM television 
        include "build.h"       ; standards. Uses a seperate file to store regional parameters, including
                                ; the ability to inject the desired region to assemble view the command
                                ; line.
                                ;
