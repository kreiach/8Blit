; S03E04 Regions
;
; Demonstrates how to handle the number of scanlines, colors, and timing
; of different regions of the world with NTSC, PAL, and SECAM television
; standards. Uses a seperate file to store regional parameters, including
