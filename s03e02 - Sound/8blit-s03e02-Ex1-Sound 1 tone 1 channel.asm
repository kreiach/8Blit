; S03e02 Ex. 1 tone, 1 channel
;
; Demonstrates basic audio generation by setting the audio registers to create
; a sound when the ball bounces. Turns volume off after a specified number
; of frames.
;
