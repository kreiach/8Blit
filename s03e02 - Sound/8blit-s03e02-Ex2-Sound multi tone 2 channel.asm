; S03E02 Ex. 2 4 tones, 2 channels, audio subroutines
;
; Demonstrates audio generation by setting the audio registers to create
; a sounds when the ball bounces, on reset, on arena selection forward and
