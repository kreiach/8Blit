; s01e07 Ex8. Demonstration of drawing two full color sprites, moving ball and the
; various size modifies you can apply to the ball. Controls the ball color by modifing
; the playfield color
;
