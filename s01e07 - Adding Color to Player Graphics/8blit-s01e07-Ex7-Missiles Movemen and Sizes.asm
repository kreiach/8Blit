; s01e07 Ex7. Demonstration of drawing two full color sprites, moving missiles and the
; various cloning and sizes for the players and missles Number-size player-missle (MUSIZ#)
;
